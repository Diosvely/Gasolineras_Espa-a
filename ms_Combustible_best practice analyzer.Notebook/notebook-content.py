...
dataset = "ms_Combustible" # Enter the name or ID of the semantic model
workspace = "Gasolineras_Spain" # Enter the workspace name or ID in which the semantic model exists
